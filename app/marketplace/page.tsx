        ...
        <TabsContent value="all" className="mt-0">
          <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 xl:grid-cols-4 gap-6">
            ...
            <MarketplaceTicketCard
              ...
              price="650"
              token="MAN"
              image="/placeholder.svg?height=400&width=300&query=football ticket NFT manchester city design"
              seller={{
                address: "0x6q7r...8s9t",
                rating: 5.0,
              }}
            ...
            <MarketplaceTicketCard
              ...
              price="150"
              token="INT"
              image="/placeholder.svg?height=400&width=300&query=football ticket NFT inter milan design"
              seller={{
                address: "0xu1v...2w3x",
                rating: 4.5,
              }}
            ...
            <MarketplaceTicketCard
              ...
              price="400"
              token="GAL"
              image="/placeholder.svg?height=400&width=300&query=football ticket NFT galatasaray design"
              seller={{
                address: "0x4y5z...6a7b",
                rating: 4.8,
              }}
            ...
            <MarketplaceTicketCard
              ...
              price="200"
              token="BAR"
              image="/placeholder.svg?height=400&width=300&query=football ticket NFT barcelona design alternative"
              seller={{
                address: "0x8c9d...0e1f",
                rating: 4.7,
              }}
